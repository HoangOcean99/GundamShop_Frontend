  ...
  useEffect(() => {
    ...
    const loadProducts = async () => {
      try {
        ...
        const products = await getAllProducts({ mainCategory: "Gundam Trung Quốc" });
    ...
    >
      ...
      <div className="max-w-[1400px] mx-auto grid grid-cols-[280px_1fr] gap-10 px-10 py-12 relative z-20">
        ...
        <main className="space-y-12">
          {loading && (
            <div className="text-center text-gray-200">Đang tải sản phẩm...</div>
          )}
          {error && (
              ...
              >
                ...
                <div className="flex items-center justify-between border-b border-white/10 pb-4 relative z-10">
                  <div className="flex items-center space-x-3">
                    <span className="text-red-800/60 text-xl">{section.icon}</span>
                ...
                {section.products.length === 0 ? (
                  <div className="text-center text-gray-400">Chưa có sản phẩm trong danh mục này.</div>
                ) : (
